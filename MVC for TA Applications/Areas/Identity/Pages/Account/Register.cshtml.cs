...
namespace MVC_for_TA_Applications.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new TAUser {Name = Input.Name, Unid = Input.Unid, UserName = Input.Email, Email = Input.Email };
